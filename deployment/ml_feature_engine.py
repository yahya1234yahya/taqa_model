...
class AvailabilityPredictor:
    """
    Feature Engineering and Prediction Pipeline for Equipment Availability
    """
    ...
    def load_historical_data(self):
        ...
        # Load equipment data
        self.equipment_data = pd.read_csv('equipment_simple.csv')
        print(f"Loaded {len(self.equipment_data)} equipment records")
        
        # Load severe words data  
        self.severe_words_data = pd.read_csv('severe_words_simple.csv')
    ...
    def extract_features(self, description, equipment_name, equipment_id):
        """
        Extract features from user input for ML prediction
        ...
        # 1. Historical equipment average score
        ...
        # 2. Equipment risk category (based on historical score)
        ...
        # 6. Weighted severity score (considering word importance)
        severity_weights = {
    ...
    def prepare_training_data(self, original_data_file='disponibilite.csv'):
        """
        Prepare training data using historical records
        """
    ...
    def predict_availability(self, description, equipment_name, equipment_id):
        """
        Predict availability for new input
        """
    ...
    def save_model(self, filepath='availability_model.pkl'):
    ...
    def load_model(self, filepath='availability_model.pkl'):
...
def main():
    """
    Example usage of the AvailabilityPredictor
    """
